  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        ...
        // Set the stock_available value in the state
        setStock_available(product.stock_available.toString());
      } catch (error) {
  ...
  return (
    <>
      <div class="p-6 flex items-center justify-center">
        <div class="container max-w-screen-sm mx-auto overflow-y-auto ">
          <div>
              ...
              <form onSubmit={saveInventory}>
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                  <div class="text-gray-900">
                    ...
                    />
                    <p class="font-medium text-lg pl-4">Create Product</p>
